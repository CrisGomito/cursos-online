...
namespace Cursos_Online.Vistas.Reportes
{
    public partial class Reporte_CursosPorEstudiante : Form
    {
        ...
        //DTO que coincide con las columnas del DataTable del xsd
        ...
        //constructor que muestra todas las inscripciones por defecto
        ...
        public Reporte_CursosPorEstudiante(int? estudianteId)
        {
            ...
            {
                //intenta buscar dentro de la carpeta bin
            ...
            //obtiene las inscripciones desde el controller
            List<Inscripcione> inscripciones;
            if (estudianteId.HasValue)
            {
                //llama al método que ya existe en elcontroller
            ...
            //nombre del XSD que coincide con el DataSource del RDLC
